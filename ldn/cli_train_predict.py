...
def _predict(
    ...
    version_geomad: str = typer.Option(..., help="Version of the GeoMAD data to use e.g. '0-0-1'."),
    ...
    model_path: str = typer.Option("https://s3.us-west-2.amazonaws.com/data.ldn.auspatious.com/lulc_random_forest_model.joblib", help="Model to use for prediction."),
